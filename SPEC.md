...
- **Plan0's own row gets a light grey background tint on any closed month's cells specifically** (not the whole row, and not Prog/Plan1's cells) — a second, independent visual cue (alongside the grey text) that a month is done and its numbers are final.
